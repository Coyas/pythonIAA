...
# Dicionário com dias trabalhados
dias_trabalhados = {}

# Função para adicionar um dia
def adicionar_dia():
    hoje = date.today().isoformat()  # Ex: '2025-06-12'
...
# GUI
janela = tk.Tk()
janela.title("Gestor de Horas de Trabalho com Calendário")
